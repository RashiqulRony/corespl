...
<div class="ie-browser"><![endif]-->
    <table class="nl-container"
        style="table-layout: fixed; vertical-align: top; min-width: 320px; border-spacing: 0; border-collapse: collapse; mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #2288c8; width: 100%;"
        cellpadding="0" cellspacing="0" role="presentation" width="100%" bgcolor="#2288c8" valign="top">
        <tbody>
                ...
                <td style="word-break: break-word; vertical-align: top;" valign="top">
                    <div style="background-color:transparent;">
                        <div class="block-grid "
                            ...
                            <div
                                style="border-collapse: collapse;display: table;width: 100%;background-color:#FFFFFF;margin-top: 70px;">
                                <!--[if (mso)|(IE)]>
                        ...
                        <![endif]-->
                                <div class="col num12"
                                    ...
                                    <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                        <tr>
                                            <td style="padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 30px; font-family: Tahoma, sans-serif">
                                    <![endif]-->
                                            <div
                                                style="color:#0D0D0D;font-family:Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;line-height:1.2;padding-top:40px;padding-right:10px;padding-bottom:30px;padding-left:10px;">
                                                <div
                                                    ...
                                                    <div style="display:flex; justify-content:center; align-item:center;">
                                                        <img src="https://jomsayur.com/frontend/img/logo-dark-1.jpeg" width="150" alt="">
                                                        </div>
                                                    <p
                                                        ...
                                                        <span style="font-size: 28px;"><strong><span
                                                                    style="font-size: 28px;padding: 20px 0;">Hi, It's Jomsayur</span></strong></span><br>
                                                        <p style="margin-top:160x;"> We are the best organic food supplier in the town. We are happily invited you to come, sign up and choose your favourite package and let us to take the whole tension of your monthly fruits and vegitables. </p>
                                                        <p style="margin-top:80x;">Invitation link and code is also attached with this email. </p>
                                                            <div
                                                                ...
                                                                <p style="margin-top:160x;"><span
                                                                    style="font-size: 20px; font-weight:500; padding-left:20px; padding-right:20px;">Invitation Link:</span>
                                                                <a href="{{ $data['link'] }}"> {{ $data['link'] }} </a> </p>
                                                                <p style="margin-top:160x;"><span
                                                                    style="font-size: 20px; font-weight:500;">Invitation Code:</span>
                                                                {{ $data['invitation_code'] }}</p>
                                                            </div>
                ...
                <td>
                    <div style="background-color:transparent;">
                        <div class="block-grid three-up"
                            style="min-width: 320px; max-width: 600px; overflow-wrap: break-word; word-wrap: break-word; word-break: break-word; Margin: 0 auto; background-color: #525252;">
                        ...
                        <td align="center" width="200"
                            style="background-color:#525252;width:200px; border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 0px solid transparent;"
                            valign="top">
                            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                                            ...
                                                            <table class="social_table" align="center" cellpadding="0"
                                                                ...
                                                                <tbody>
                                                                    <tr style="vertical-align: top; display: inline-block; text-align: center;"
                                                                        ...
                                                                        <td style="word-break: break-word; vertical-align: top; padding-bottom: 5px; padding-right: 5px; padding-left: 0;"
                                                                            valign="top"><a href="https://www.instagram.com"
                                                                                target="_blank"><img width="32"
                                                                                    height="32"
                                                                        ...
                                                                        <td style="word-break: break-word; vertical-align: top; padding-bottom: 5px; padding-right: 5px; padding-left: 0;"
                                                                            valign="top"><a href="https://www.youtube.com/channel/UCJAoUMSsXCmQ6qPBvC8n1XA"
                                                                                target="_blank"><img width="32"
                                                                                    height="32"
                                                                                    src="https://d2fi4ri5dhpqd1.cloudfront.net/public/resources/social-networks-icon-sets/t-only-logo-default-gray/youtube@2x.png"
                                                                                    alt="Youtube" title="Youtube"
                                                                                    style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: 0; display: block;"></a>
                                                                        </td>
                                                                        <td style="word-break: break-word; vertical-align: top; padding-bottom: 5px; padding-right: 5px; padding-left: 0;"
                                                                            valign="top"><a href="https://www.linkedin.com/company/73808566/"
                                                                                target="_blank"><img width="32"
                                                                                    height="32"
                        ...
                        <![endif]-->
                                <div class="col num4"
                                    ...
                                    <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                        <tr>
                                            <td style="padding-right: 0px; padding-left: 0px; padding-top: 20px; padding-bottom: 0px; font-family: Tahoma, sans-serif">
                                    <![endif]-->
                                            <div
                                                style="color:#2288c8;font-family:Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;line-height:1.2;padding-top:20px;padding-right:0px;padding-bottom:0px;padding-left:0px;">
                                                <div
                                                    style="font-size: 12px; line-height: 1.2; color: #8a8d8f; font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif; mso-line-height-alt: 14px;">
                                                    <p
                                                        ...
                                                        <span style="color: #ffffff; font-size: 12px;"><span
                                                                style="font-size: 12px; color: #2288c8;"><i
                                                                    class="lni lni-mobile"></i></span> +44 000 000 0000
                                                            </span><br>
                                                    </p>
                                                </div>
                                            </div>
                                ...
                                <div class="col num4"
                                    ...
                                    <![endif]-->
                                            <div
                                                style="color:#2288c8;font-family:Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;line-height:1.2;padding-top:20px;padding-right:0px;padding-bottom:0px;padding-left:0px;">
                                                <div
                                                    style="font-size: 12px; line-height: 1.2; color: #2288c8; font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif; mso-line-height-alt: 14px;">
                                                    <a href="mailto:info@jomsayur.com"
                                                        style="color: #ffffff; font-size: 12px;">info@jomsayur.com</a>
                                                </div>
                                            </div>
                                            <!--[if mso]></td></tr></table><![endif]-->
                                            <!--[if (!mso)&(!IE)]><!-->
                    ...
                    <div style="background-color:transparent;">
                        <div class="block-grid "
                            ...
                            <div
                                ...
                                <!--<table width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:transparent;"><tr><td align="center"><table cellpadding="0" cellspacing="0" border="0" style="width:600px"><tr class="layout-full-width" style="background-color:transparent"><![endif]-->
                                    ...
                                    <div class="col_cont" style="width:100% !important;">
                                        <div
                                            ...
                                            <div class="img-container center fullwidth" align="center"
                                                ...
                                                <!--<table width="100%" cellpadding="0" cellspacing="0" border="0"><tr style="line-height:0px"><td style="padding-right: 0px;padding-left: 0px;" align="center"><![endif]--><img
